...
<script>
// ── Auto-generate slug and SKU hint from name ────────────────────
...
function addSpec() {
    ...
    div.className = 'spec-row-input form-row';
...
async function saveProduct() {
    ...
    // Collect spec pairs into an object
    ...
    try {
        ...
        if (data.success) {
            window.location.href = '/admin/products.php?saved=1';
        } else {
