...
<div class="help-page-container">
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:32px;margin-bottom:48px">
        <?php foreach ([
            ...
            'Account'  => ['Dashboard'=>'/account/index.php','My Orders'=>'/account/orders.php','Addresses'=>'/account/addresses.php','Settings'=>'/account/settings.php','Order Detail'=>'/orders/detail.php'],
