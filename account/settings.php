...
<div class="sidebar-layout">
    ...
    <main class="account-main">
        ...
        <div class="card">
            ...
            <div class="pref-list">
                <?php foreach ([
                    ['Order status updates',    'Get notified when your order status changes',       true],
                    ['Shipping notifications',  'Track your packages with email updates',            true],
                    ['Promotional emails',      'Deals, new products, and special offers',           false],
                    ['Wholesale alerts',        'New bulk pricing and B2B offers',                   false],
